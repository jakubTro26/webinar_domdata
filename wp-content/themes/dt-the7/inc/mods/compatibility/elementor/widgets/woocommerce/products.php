...
//		$this->add_render_attribute( 'article_wrapper', 'data-date', get_the_date( 'c' ) );
	...
	protected function add_content_controls() {
		...
		$icon_visibility_options        = [
			'always'   => __( 'Always', 'the7mk2' ),
			'on-hover' => __( 'On box hover', 'the7mk2' ),
		];
		$device_icon_visibility_options = [ 'default' => __( 'No change', 'the7mk2' ) ] + $icon_visibility_options;
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'device_args'  => [
					'tablet' => [
						'options' => $device_icon_visibility_options,
					],
					'mobile' => [
						'options' => $device_icon_visibility_options,
					],
				],
				'prefix_class' => 'cart-btn%s-',
				'selectors'    => [
					'{{WRAPPER}}.cart-btn-on-hover .woo-buttons' => 'opacity: 0;',
					'{{WRAPPER}}.cart-btn-on-hover .woocom-project:hover .woo-buttons' => 'opacity: 1;',
					'(tablet) {{WRAPPER}}.cart-btn-tablet-on-hover .woo-buttons'  => 'opacity: 0;',
					'(tablet) {{WRAPPER}}.cart-btn-tablet-on-hover .woocom-project:hover .woo-buttons' => 'opacity: 1;',
					'(tablet) {{WRAPPER}}.cart-btn-tablet-always .woocom-project .woo-buttons' => 'opacity: 1;',
					'(mobile) {{WRAPPER}}.cart-btn-mobile-on-hover .woocom-project .woo-buttons'  => 'opacity: 0;',
					'(mobile) {{WRAPPER}}.cart-btn-mobile-on-hover .woocom-project:hover .woo-buttons' => 'opacity: 1;',
					'(mobile) {{WRAPPER}}.cart-btn-mobile-always .woocom-project .woo-buttons' => 'opacity: 1;',
				],
				'condition'    => [
					'layout' => 'btn_on_img',
				],
